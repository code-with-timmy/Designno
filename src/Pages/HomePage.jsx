        ...
        <div className="relative  bg-peach md:rounded-md w-full square-with-circle overflow-hidden pt-10">
          <div className="flex items-center max-md:flex-col justify-between w-[80%] gap-5 h-full mx-auto">
            <div className="flex gap-10 max-sm:gap-4   flex-col w-[50%] max-sm:w-[90%] max-sm:mt-5">
              <h2 className="text-white font-medium text-[48px] max-sm:text-[25px] max-sm:text-center leading-12 max-sm:leading-7">
                Award-winning custom designs and digital branding solutions
              </h2>
              <p className="text-white text-[16px] max-sm:text-[12px] max-sm:text-center">
                With over 10 years in the industry, we are experienced in
                creating fully responsive websites, app design, and engaging
                brand experiences. Find out more about our services.
              </p>
              <button className="bg-white text-[15px] max-sm:text-[11px] max-sm:self-center  rounded-[10px] p-4 max-sm:p-2 w-fit">
                LEARN MORE
              </button>
            </div>

...
function ExploreOptions() {
  ...
  return (
    <section className="explor h-full my-auto gap-10 grid lg:grid-cols-2 max-sm:grid-cols-1 md:grid-rows-2 auto-rows-[250px] text-white">
      ...
      <div
        className={`h-full w-full max-sm:w-[90%] max-sm:mx-auto bg-[url('/appDesign.png')] bg-cover rounded-[10px] ${
      ...
      <div
        className={`h-full w-full max-sm:w-[90%] max-sm:mx-auto bg-[url('/graphicDesign.png')] bg-cover rounded-[10px] ${

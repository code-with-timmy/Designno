...
function GraphicDesign() {
  return (
    <div className="flex flex-col gap-30">
      <section className="relative overflow-hidden flex flex-col py-28 md:py-15 md:w-[80%] md:mx-auto md:rounded-xl gap-5 px-3 text-white bg-peach items-center circle-grad">
        ...
        <h3 className="text-[30px] font-medium">Graphic Design</h3>
        <p className=" text-[15px] text-center md:w-[55%]">
